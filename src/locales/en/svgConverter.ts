export default {
  ...
  toolbar: {
    ...
    fit: 'Fit to Screen', reset: 'Reset Zoom', canvasBg: 'Canvas Background',
    preview: 'Preview', split: 'Split', code: 'Code'
  },
  transform: {
    title: 'Transform', rotate: 'Rotate', flip: 'Flip',
    flipH: 'Horizontal', flipV: 'Vertical', scale: 'Scale',
  },
  optimize: {
    title: 'Optimize', original: 'Original', current: 'Current', mode: 'Mode',
    modeSafe: 'Safe', modeAggressive: 'Aggressive',
    btnOptimize: 'Optimize',
    copySvg: 'Copy SVG', copyOptimized: 'Copy Optimized',
    copyOriginal: 'Restore Original',
    optimizeSuccess: 'Optimized! Saved {{bytes}} bytes ({{percent}}%)',
  ...
  export: {
    ...
    bgTransparent: 'Transparent', bgWhite: 'White', bgBlack: 'Black',
  ...
  libraryModal: {
    title: 'Icon Library', search: 'Search icons...',
    results: '{{count}} results', loadMore: 'Load more',
  },
  urlModal: {
    title: 'Load from URL',
    desc: 'Enter a valid remote SVG file URL to load directly.',
    placeholder: 'https://example.com/icon.svg',
    cancel: 'Cancel', load: 'Load SVG', loadSuccess: 'SVG loaded successfully'
  },
  article: {
    introTitle: 'SVG Editor Guide',
    introDesc: 'Paste your SVG code, or drag & drop files. Real-time preview, aggressive minification, and PNG export.',
    principle: 'Pure Local Rendering: 100% processed in your browser. No server uploads, zero privacy risk.',
    howToUse: 'How to Use',
    whatIs: 'FAQ',
    whatIsDesc1: 'Some tips to get you started:',
    whatIsDesc2: '',
