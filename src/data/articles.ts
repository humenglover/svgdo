...
export const tagLabels: Record<string, Record<string, string>> = {
  'SVG':        { zh: 'SVG',         en: 'SVG',         ja: 'SVG',         ko: 'SVG' },
  'vector':     { zh: '矢量',        en: 'Vector',      ja: 'ベクター',    ko: '벡터' },
  'design':     { zh: '设计',        en: 'Design',      ja: 'デザイン',    ko: '디자인' },
  'guide':      { zh: '指南',        en: 'Guide',       ja: 'ガイド',      ko: '가이드' },
  'tutorial':   { zh: '教程',        en: 'Tutorial',    ja: 'チュートリアル', ko: '튜토리얼' },
  'formats':    { zh: '格式',        en: 'Formats',     ja: 'フォーマット', ko: '포맷' },
  'optimization': { zh: '优化',      en: 'Optimization', ja: '最適化',     ko: '최적화' },
  'web-dev':    { zh: '前端开发',    en: 'Web Dev',     ja: 'ウェブ開発',  ko: '웹 개발' },
  'animation':  { zh: '动画',        en: 'Animation',   ja: 'アニメーション', ko: '애니메이션' },
  'tips':       { zh: '技巧',        en: 'Tips',        ja: 'ヒント',      ko: '팁' },
  'beginner':   { zh: '入门',        en: 'Beginner',    ja: '初心者',      ko: '초보자' },
  'comparison': { zh: '对比',        en: 'Comparison',  ja: '比較',        ko: '비교' },
}
...
export const articles: Article[] = [
  {
    ...
    date: '2026-07-16',
    excerpt: { zh: '从零开始了解 SVG。可缩放矢量图形是什么？它和 PNG、JPEG 有什么区别？为什么设计师和前端开发者都在用它？', en: 'Learn SVG from scratch. What is Scalable Vector Graphics? How does it differ from PNG and JPEG? Why designers and developers love it.', ja: 'SVGをゼロから学ぶ。スケーラブルベクターグラフィックスとは？PNGやJPEGとの違いは？デザイナーや開発者が愛用する理由。', ko: 'SVG를 처음부터 배워보세요. 스케일러블 벡터 그래픽스란? PNG 및 JPEG와의 차이점은? 디자이너와 개발자가 사랑하는 이유.' },
